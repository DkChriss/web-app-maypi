    ...
    // Admin routes
    {
        ...
        children: [
            ...
            // Apps
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/search-rescue/search-rescue.routes'
                            ),
                    },
                    {
                        path: 'prevention',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/prevention/prevention.routes'
                            ),
                    },
                    {
                        path: 'reports',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/apps/reports/reports.routes'
                            ),
                    },
                ],
            },
            ...
            //DASHBOARDS
            {
                path: 'dashboards',
                loadChildren: () =>
                    import('app/modules/dashboard/dashboard.routes'),
            },
        ],
    },
];
