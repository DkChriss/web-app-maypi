...
import { MissingPersonService } from '../recdesaparecidos/services/missing_person.service';
import { MissingPerson, MissingPersonCategory, MissingPersonPagination } from '../recdesaparecidos/models/missing_person.model';
import { MatDialogModule, MatDialog } from '@angular/material/dialog';
import { MissingPersonDetailsDialogComponent } from '../recdesaparecidos/missing-person-details-dialog/missing-person-details-dialog.component';
...
export class HelpCenterRecInfoDesaparecidosComponent implements OnInit, OnDestroy {
