...
export class EmergencyContactEditFormComponent implements OnInit {
    ...
    formSubmit(): void {
        ...
        if (this.form.formGroup.valid) {
            ...
            let emergencyContactUpdate: EmergencyContactUpdate = this.form.formGroup.getRawValue();
            emergencyContactUpdate.user_id = this.current_user.id;
            this._emergencyContactService.update(this.data.emergencyContact.id, emergencyContactUpdate).subscribe({
